...
const api: NovelReaderApi = {
  ...
  getOfflineManualImportState: (providerId) => ipcRenderer.invoke('tts:offline-manual-import-state', providerId) as Promise<OfflineManualImportState>,
  chooseOfflineManualImport: (providerId, target) => ipcRenderer.invoke('tts:offline-manual-import-choose', providerId, target) as Promise<OfflineManualImportResult>,
